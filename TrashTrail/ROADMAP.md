...
- [x] **Frontend Architecture**: Next.js 14 App Router with Tailwind CSS.
- [x] **Core Models**: Local JSON schemas for Users (Rbac), WasteBags, Complaints, and Anomalies.
- [x] **Admin Dashboard**: Live metrics, collection trends, and ward-wise insights connected to real DB.
- [x] **API Layer**: Secure endpoints for analytics, waste registration, and anomaly detection.
- [x] **Authentication**: NextAuth.js JWT-based session management.
